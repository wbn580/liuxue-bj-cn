...
const REF = "dist/blog/uk-study-abroad-agency-ranking-beijing-2026/index.html"; // 参考页（已构建产物里的一篇真实文章页）
const SEG = "blog";
const DEFAULT_OG = "https://liuxue.bj.cn/og-image.jpg"; // 站点默认 og 图（绝对 URL，可为空串）
