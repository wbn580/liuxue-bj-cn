// liuxue-bj-cn —— 静态资产 + D1 运行时文章层（R254 通用模板实例）
//
...
const ORIGIN = "https://liuxue.bj.cn";
const SEG = "blog"; // 文章 URL 段（sites.yaml render_url_segment）
const SITEMAP_BASE = "/sitemap-0.xml"; // 构建产物里的 sitemap 静态正本路径
const LLMS_BASE = "/llms-base.txt"; // 构建产物里的 llms 静态正本路径
const SITEMAP_TRAILING = false; // 合成 sitemap loc 是否带尾斜杠
const DATE_STYLE = "zh"; // "zh" | "iso"
